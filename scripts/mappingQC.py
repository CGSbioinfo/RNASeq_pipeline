...
def junctions(i):
    os.system("python /usr/local/miniconda/bin/junction_annotation.py -i " + 
        ...
        out_dir + '/' + i + " -r " + bedFile + " & ")
    os.system("python /usr/local/miniconda/bin/junction_saturation.py -i " + 
        in_dir + '/' + i +"Aligned.sortedByCoord.out.bam  -o " + 
        out_dir + '/' + i + " -r " + bedFile)
...
if __name__ == '__main__':
    ...
    bedFile=functions.read_analysis_info_file(params_file)['BedFile']
    refFlat=functions.read_analysis_info_file(params_file)['refFlat']
    rRNA_interval_list=functions.read_analysis_info_file(params_file)['rRNA_interval_list']
